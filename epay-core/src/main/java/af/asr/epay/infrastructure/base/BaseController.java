...
import af.asr.epay.infrastructure.exception.UnAuthorizedException;
...
public class BaseController<T extends BaseEntity, R extends BaseService> {
    ...
    public @ResponseBody ResponseEntity<Iterable<T>> findAll() {
    ...
    public @ResponseBody ResponseEntity<Iterable<T>> findAllThatIsNotDeleted() {
    ...
    public @ResponseBody ResponseEntity<Iterable<T>> findAllThatIsDeleted() {
    ...
    public @ResponseBody ResponseEntity<Optional<T>> findById(@PathVariable(name = "id", required = true) String id) {
    ...
    public @ResponseBody ResponseEntity<T> update(@RequestBody(required = true) T obj,
    ...
    public @ResponseBody ResponseEntity<Void> delete(@PathVariable(name = "id", required = true) String id) {
        service.delete(id);
