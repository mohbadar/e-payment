package af.asr.epay.infrastructure.audit;

import java.net.UnknownHostException;
import java.time.LocalDateTime;
import java.time.ZoneOffset;

import af.asr.epay.infrastructure.audit.builder.AuditRequestBuilder;
import af.asr.epay.infrastructure.audit.data.AuditRequestDto;
import af.asr.epay.infrastructure.audit.handler.AuditHandler;
import af.asr.epay.infrastructure.constant.ApplicationGenericConstants;
import af.gov.anar.core.infrastructure.exception.common.ExceptionUtils;
import af.gov.anar.lib.logger.Logger;
import af.asr.epay.infrastructure.enumeration.AuditEvent;
import af.asr.epay.infrastructure.enumeration.Components;
import af.asr.epay.infrastructure.base.HostService;
import af.asr.epay.infrastructure.base.UserService;
import af.asr.epay.infrastructure.util.LoggerFactory;
...
//    private AuditHandlerImpl auditHandler;
    ...
    public void audit(AuditEvent auditEventEnum, Components appModuleEnum, String refId, String refIdType) {
        ...
        auditRequestBuilder.setActionTimeStamp(LocalDateTime.now(ZoneOffset.UTC))
                .setApplicationId(ApplicationGenericConstants.APPLICATION_ID)
                .setApplicationName(ApplicationGenericConstants.APPLICATION_NAME)
