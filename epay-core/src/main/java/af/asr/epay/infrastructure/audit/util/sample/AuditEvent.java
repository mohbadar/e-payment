package af.asr.epay.infrastructure.audit.util.sample;


import lombok.Getter;

import static af.asr.epay.infrastructure.audit.util.AuditEventType.SYSTEM_EVENT;
import static af.asr.epay.infrastructure.audit.util.AuditEventType.USER_EVENT;
